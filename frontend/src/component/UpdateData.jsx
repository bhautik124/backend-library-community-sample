...
const CRUD__UPDATE_API_KEY = "o0ujSj8";
const CRUD__UPDATE_TOKEN =
...
export default function UpdateData() {
  ...
  // State to manage the current page for each model's internal pagination
  ...
  useEffect(() => {
    const fetchModels = async () => {
      try {
        ...
        // Initialize pagination state for each model, setting the current page to 1
      ...
      {models.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {models.map((model, idx) => {
            // Pagination calculations for the current model
            ...
            return (
              ...
              >
                ...
                <div className="flex-grow space-y-4">
                  {paginatedData.length === 0 && model.data.length === 0 ? (
                    ...
                    paginatedData.map((doc, index) => (
                      ...
                      >
                        {/* Fields with new Title/Content layout */}
                        ...
                        <div className="mt-4">
                          <button
                            ...
                            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-200"
                          >
                            Update
                          </button>
                        </div>
                ...
                {/* Pagination Controls for each card */}
                {totalPages > 1 && (
